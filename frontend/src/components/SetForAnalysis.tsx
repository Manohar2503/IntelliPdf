...
export function SetForAnalysis() {
  ...
  // ✅ NEW: rotating tips while processing
  const tips = [
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Something went wrong while processing your PDF",
        variant: "destructive",
      });
    } finally {
